...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Jun 17 23:33:04 CST 2017
  */
                                                                                                        ...
                                                                                                        if(tmp2==null){
                                                                                                            ...
                                                                                                            if(tmp2.valor == null)
                                                                                                                ...
                                                                                                                if ((ambito2.equals(SymbolTable.profundidad))|| (ambito2.equals("main")) ||(ambito2.contains(SymbolTable.profundidad))||ambito2.contains("function")){
                                                                                                                    ...
                                                                                                                    if(term.getTemp()== null){
                                                                                                                        Cuadruplo cuad = new Cuadruplo ("/", term.toString(), fact.toString(), tmp15.getTemp());
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }else{
                                                                                                                        Cuadruplo cuad = new Cuadruplo ("/", term.getTemp().getTemp(), fact.toString(),tmp15.getTemp());
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }
                                                                                                                }else{
                                                                                                                    System.err.println("Error en la linea: "+divleft+" ,variable no ha sido declarada");  
                                                                                            ...
                                                                                            if(tmp.valor == null)
                                                                                                ...
                                                                                                if(tmp.getTipo().equals("integer")){
                                                                                                    ...
                                                                                                    if(fact.getType()==4){
                                                                                                        if ((ambito.equals(SymbolTable.profundidad))|| (ambito.equals("main")) ||(ambito.contains(SymbolTable.profundidad))){
                                                                                                            Temp tmp12 = new Temp();
                                                                                                            RESULT = new Term(new Factor(Integer.parseInt(tmp.valor.toString())*Integer.parseInt(fact.toString())),tmp12);
                                                                                                            
                                                                                                            if(term.getTemp()== null){
                                                                                                                Cuadruplo cuad = new Cuadruplo ("*", term.toString(), fact.toString(), tmp12.getTemp());
                                                                                                                Cuadruplos.add(cuad);
                                                                                                            }else{
                                                                                                                Cuadruplo cuad = new Cuadruplo ("*", term.getTemp().getTemp(), fact.toString(),tmp12.getTemp());
                                                                                                                Cuadruplos.add(cuad);
                                                                                                            }
                                                                                                        }else{
                                                                                                            System.err.println("Error en la linea: "+timleft+" ,variable no ha sido declarada");  
                                                                                                        ...
                                                                                                        if(tmp2==null){
                                                                                                            ...
                                                                                                            if(tmp2.valor == null)
                                                                                                                ...
                                                                                                                if ((ambito2.equals(SymbolTable.profundidad))|| (ambito2.equals("main")) ||(ambito2.contains(SymbolTable.profundidad))){
                                                                                                                    Temp tmp13 = new Temp();
                                                                                                                    RESULT = new Term(new Factor(Integer.parseInt(tmp.valor.toString())*Integer.parseInt(tmp2.valor.toString())),tmp13);
                                                                                                                    if(term.getTemp()== null){
                                                                                                                        Cuadruplo cuad = new Cuadruplo ("*", term.toString(), fact.toString(), tmp13.getTemp());
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }else{
                                                                                                                        Cuadruplo cuad = new Cuadruplo ("*", term.getTemp().getTemp(), fact.toString(),tmp13.getTemp());
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }
                                                                                                                }else{
                                                                                                                    System.err.println("Error en la linea: "+timleft+" ,variable no ha sido declarada");  
                                                                                                        ...
                                                                                                        if(tmp2==null){
                                                                                                            ...
                                                                                                            if(tmp2.valor == null)
                                                                                                                ...
                                                                                                                if ((ambito2.equals(SymbolTable.profundidad))|| (ambito2.equals("main")) ||(ambito2.contains(SymbolTable.profundidad))){
                                                                                                                    ...
                                                                                                                    if (se1.getTemp() == null && term.getTemp() == null){
                                                                                                                        Cuadruplo cuad  =  new Cuadruplo ("-",se1.toString(),term.toString(),tmp10.getTemp());
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }else if(term.getTemp()!=null && se1.getTemp() == null){
                                                                                                                        Cuadruplo cuad = new Cuadruplo ("-", se1.toString(),term.getTemp().getTemp(),tmp10.getTemp()); 
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }else if (term.getTemp()==null && se1.getTemp() != null){
                                                                                                                        Cuadruplo cuad = new Cuadruplo ("-", se1.getTemp().getTemp(),term.toString(),tmp10.getTemp()); 
                                                                                                                        Cuadruplos.add(cuad);
                                                                                                                    }else{
                                                                                                                       Cuadruplo cuad = new Cuadruplo ("-", se1.getTemp().getTemp(),term.getTemp().getTemp(),tmp10.getTemp()); 
                                                                                                                       Cuadruplos.add(cuad); 
                                                                                                                    }
                                                                                                                }else{
                                                                                                                    System.err.println("Error en la linea: "+minleft+" ,variable no ha sido declarada");  
                                                                                                            ...
                                                                                                            if(tmp2==null){
                                                                                                                ...
                                                                                                                if(tmp2.valor == null)
                                                                                                                    ...
                                                                                                                    if ((ambito2.equals(SymbolTable.profundidad))|| (ambito2.equals("main")) ||(ambito2.contains(SymbolTable.profundidad))){
                                                                                                                        ...
                                                                                                                        if (se1.getTemp() == null && term.getTemp() == null){
                                                                                                                            Cuadruplo cuad  =  new Cuadruplo ("+",se1.toString(),term.toString(),tmp6.getTemp());
                                                                                                                            Cuadruplos.add(cuad);
                                                                                                                        }else if(term.getTemp()!=null && se1.getTemp() == null){
                                                                                                                            Cuadruplo cuad = new Cuadruplo ("+", se1.toString(),term.getTemp().getTemp(),tmp6.getTemp()); 
                                                                                                                            Cuadruplos.add(cuad);
                                                                                                                        }else if (term.getTemp()==null && se1.getTemp() != null){
                                                                                                                            Cuadruplo cuad = new Cuadruplo ("+", se1.getTemp().getTemp(),term.toString(),tmp6.getTemp()); 
                                                                                                                            Cuadruplos.add(cuad);
                                                                                                                        }else{
                                                                                                                           Cuadruplo cuad = new Cuadruplo ("+", se1.getTemp().getTemp(),term.getTemp().getTemp(),tmp6.getTemp()); 
                                                                                                                           Cuadruplos.add(cuad); 
                                                                                                                        }
