...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Jun 07 21:47:04 CST 2017
  */
      ...
      switch (CUP$parser$act_num)
		...
		Type tipo = (Type)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new Procedure_d (id,tipo,p);
                                                                                ...
                                                                                SymbolTable.crear(p.getParametros().get(i).getId(), p.getParametros().get(0).getTipo().toString(), id);
                                                                                }
