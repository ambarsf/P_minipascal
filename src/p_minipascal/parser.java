...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Jun 06 22:13:10 CST 2017
  */
                                                                                    ...
                                                                                    if(tmp.valor == null){
                                                                                        ...
                                                                                        if(tipoVariable.equals("integer")&&tmp2==null){
                                                                                            if(ex.getS_exp1()!=null){
                                                                                                ...
                                                                                                if((ex.getS_exp1().getTerm().getFact().getType()==4)&&(ambito1.equals(ambito2)||ambito1.equals(" ")||ambito2.equals(" ")))
                                                                                            ...
                                                                                            if(ex.getS_exp1()!=null){
                                                                                                if((ex.getS_exp1().getTerm().getFact().getType()==2)&&(ambito1.equals(ambito2)||ambito1.equals(" ")||ambito2.equals(" ")))
                                                                                                    SymbolTable.insertar(v.toString(), ex);
                                                                                                else
                                                                                                    System.err.println("Tipo de asignacion incompatible");
                                                                                            }
                                                                                            ...
                                                                                            if(ex.getS_exp1()!= null){
                                                                                                if((ex.getS_exp1().getTerm().getFact().getType()==3)&&(ambito1.equals(ambito2)||ambito1.equals(" ")||ambito2.equals(" ")))
                                                                                                    SymbolTable.insertar(v.toString(), ex);
                                                                                                else
                                                                                                    System.err.println("Tipo de asignacion incompatible");
                                                                                            }
