...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Jun 17 20:40:28 CST 2017
  */
      ...
      switch (CUP$parser$act_num)
		...
		Factor fact = (Factor)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                                                                    ...
                                                                                    if(term.getFact().getType()==4){
                                                                                        ...
                                                                                        else if(fact.getType()==1||fact.getType()==5){
                                                                                            Simbolo tmp2 = null;
                                                                                    ...
                                                                                    else if(term.getFact().getType()==1||term.getFact().getType()==5){
                                                                                        Simbolo tmp = null;
		...
		Term term = (Term)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                                                                                    ...
                                                                                    if(se1.getTerm().getFact().getType()==4){
                                                                                        ...
                                                                                        else if(se1.getTerm().getFact().getType()==1||se1.getTerm().getFact().getType()==5){
                                                                                        Simbolo tmp = null;
