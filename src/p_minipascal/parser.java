...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Jun 18 20:01:49 CST 2017
  */
      ...
      switch (CUP$parser$act_num)
		...
		Compound_stament sts = (Compound_stament)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new For_stament(new Parameter(id,m),n,sts);
                                                                                   Simbolo sim = SymbolTable.buscar(id);
                                                                                   if(sim == null){
                                                                                        SymbolTable.crear(id, "integer", "FOR");
                                                                                        SymbolTable.insertar(id, m); 
                                                                                        ...
                                                                                        Etiqueta.cicloActual = "FOR";
                                                                                        Cuadruplo cuad = new Cuadruplo("ASSIGN",m.toString(),"",id);
                                                                                        Cuadruplos.add(cuad);
                                                                                        //etiq = new Etiqueta();
                                                                                        //cuad= new Cuadruplo("<=", id, n.toString(), tmp.getTemp());
                                                                                        cuad= new Cuadruplo("<=", id, n.toString(), etiq.toString());
                                                                                        Cuadruplos.add(cuad);
                                                                                        //etiq = new Etiqueta();
                                                                                        //Integer controlador = Etiqueta.cont +4;
                                                                                        //cuad = new Cuadruplo("false", controlador.toString(), tmp.getTemp(), "");
                                                                                        //Cuadruplos.add(cuad);
                                                                                    }
                                                                                    else
                                                                                        System.err.println("Ya existe la variable " + id + "No se puede usar en el FOR" );
              CUP$parser$result = parser.getSymbolFactory().newSymbol("for_stament",39, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		sts.add(st); RESULT = sts;
                                                                                  /*if(Etiqueta.cicloActual.matches("FOR")){
                                                                                    Etiqueta etiq = new Etiqueta();
                                                                                    etiq = new Etiqueta();
                                                                                    Cuadruplo cuad = new Cuadruplo("+","i","1","i");
                                                                                    Cuadruplos.add(cuad);
                                                                                    etiq = new Etiqueta();
                                                                                    Integer controlador = Etiqueta.cont-4;
                                                                                    cuad = new Cuadruplo("GOTO", controlador.toString(),"","");
                                                                                    Cuadruplos.add(cuad);
                                                                                    Etiqueta.cicloActual = "";
                                                                                  }*/
              CUP$parser$result = parser.getSymbolFactory().newSymbol("staments",33, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
