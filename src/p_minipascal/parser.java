...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Jun 11 15:43:41 CST 2017
  */
      ...
      switch (CUP$parser$act_num)
                                                                                    ...
                                                                                    if(tmp.valor == null){                                                                                       
                                                                                        ...
                                                                                        if(tipoVariable.equals("integer")&&tmp2==null){
                                                                                            if(ex.getS_exp1()!=null){
                                                                                                System.out.println("Esta es la variable "+ tmp.nombre+ " Este es el ambito: "+ ambito1+ " Esta es la prof: "+ SymbolTable.profundidad);
                                                                                                if (ex.getS_exp1().getTerm().getFact().getType()==4)
                                                                                                    if ((ambito1.equals(SymbolTable.profundidad)) ||
                                                                                                       (ambito1.equals(" ") && !SymbolTable.profundidad.equals(" ")) || (ambito1.contains(SymbolTable.profundidad))){
		...
		Type tipo = (Type)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Variable_d(id,tipo); 
                                                                                ...
                                                                                SymbolTable.crear(id, tipo.toString(),"main");
